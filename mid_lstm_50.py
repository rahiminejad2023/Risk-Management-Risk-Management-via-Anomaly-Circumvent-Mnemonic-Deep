...
#n=len(filename)
n=10
if os.path.isfile('Data/Mid_LSTM_451_4.npy'):

  result_Mid_LSTM_df1=np.load('Data/Mid_LSTM_451_4.npy', allow_pickle=True)
...
for i in range(0,n):
  ...
  if data2==0:
      ...
      print(i)
      np.save('Data/Mid_LSTM_451_4.npy', result_Mid_LSTM_df)

data=np.load('Data/Mid_LSTM_451_4.npy', allow_pickle=True)
