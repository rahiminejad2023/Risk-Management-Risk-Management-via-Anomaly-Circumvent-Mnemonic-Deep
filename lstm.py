...
for i in range(416,n):
  index=i
  stock=filename[i]
  result=stock_loop("Data\\"+filename[i])
  MSE=result[0]
  accuracy=result[1]
  true=result[2]
  predict=result[3]
  ...
  print(i)
  np.save('Data\\L1_451.npy',result_LSTM_df)

'''
#Reshape data
L4_all=np.load('Data\\L1_451.npy',allow_pickle=True)
L4_all=pd.DataFrame(L4_all)
#L4_all.columns=['MSE','accuracy','index','predict','stock','TRUE']
L4_all.columns=['index','stock','MSE','accuracy','TRUE','predict']
...
for i in range(0,n):
  ...
  print(i)
np.save('Data\\L1_r.npy',result_df)

##Mean MPA of all stocks
L1_r=np.load('Data\\L1_r.npy', allow_pickle=True)
L1_r=pd.DataFrame(L1_r)
#L1_r.columns=['MSE','TRUE','accuracy','index','predict','stock']
L1_r.columns=['index','stock','MSE','accuracy','TRUE','predict']
...
LH_dph=np.load('Data\\L1_r.npy',allow_pickle=True)
LH_dph=pd.DataFrame(LH_dph)
# LH_dph.columns = ['MSE','TRUE','accuracy','index','predict','stock']
LH_dph.columns = ['index','stock','MSE','accuracy','predict','TRUE']
