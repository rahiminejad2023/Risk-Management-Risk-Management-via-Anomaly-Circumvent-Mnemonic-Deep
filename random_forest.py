...
for i in range(0,n):
  index=i
  stock=filename[i]
  result=stock_RF_loop("Data\\"+filename[i])
  ...
  print(i)
  np.save('Data\\RF_451.npy',result_RF_df)
  # result_RF_df.save('Deta\\RF_d0.csv')
  '''
#Reshape data
L4_all=np.load('Data\\RF_451.npy',allow_pickle=True)
...
for i in range(0,n):
  ...
  result_df=result_df.append(pd.DataFrame({'index':index,'stock':[stock],                                           'TRUE':[TRUE],
                                           'predict':[predict],
                                          'accuracy':[accuracy],
                                          'MSE':[MSE]}),
                             ignore_index=True)
  print(i)
np.save('Data\\RF_r.npy',result_df)

##Mean MPA of all stocks
RF_r=np.load('Data\\RF_r.npy',allow_pickle=True)
RF_r=pd.DataFrame(RF_r)
#RF_r.columns=['MSE','TRUE','accuracy','index','predict','stock']
RF_r.columns=['index','stock','TRUE','predict','accuracy','MSE']
